    ...
    <main className="bg-gray-100 min-h-screen">
        <div className="max-w-5xl m-auto bg-white pb-10">
            ...
            <div className='max-w-sm m-auto my-10'>
                ...
                <strong className='text-xs'>By clicking "Complete reservation" you agree to the OpenTable Terms of use and Privacy Policy. Standard text message rates may opt out of receving text messages at any time.</strong>
                </div>
        </div>
    </main>
  )
